...
namespace test_img {
    ...
    public partial class TestDataSet : global::System.Data.DataSet {
        ...
        public partial class ImageDataTable : global::System.Data.TypedTableBase<ImageRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ImageRow AddImageRow(int ImageID, string ImageName, byte[] ImageData) {
...
namespace test_img.TestDataSetTableAdapters {
    ...
    public partial class ImageTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Image] WHERE (([ImageID] = @Original_ImageID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Image] ([ImageID], [ImageName], [ImageData]) VALUES (@ImageID," +
                " @ImageName, @ImageData);\r\nSELECT ImageID, ImageName, ImageData FROM Image WHERE" +
                " (ImageID = @ImageID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Image] SET [ImageID] = @ImageID, [ImageName] = @ImageName, [ImageDa" +
                "ta] = @ImageData WHERE (([ImageID] = @Original_ImageID));\r\nSELECT ImageID, Image" +
                "Name, ImageData FROM Image WHERE (ImageID = @ImageID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::test_img.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ImageID, ImageName, ImageData FROM dbo.Image";
        ...
        public virtual int Fill(TestDataSet.ImageDataTable dataTable) {
        ...
        public virtual TestDataSet.ImageDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDataSet.ImageDataTable dataTable = new TestDataSet.ImageDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDataSet.ImageDataTable dataTable) {
        ...
        public virtual int Insert(int ImageID, string ImageName, byte[] ImageData) {
        ...
        public virtual int Update(int ImageID, string ImageName, byte[] ImageData, int Original_ImageID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ImageName, byte[] ImageData, int Original_ImageID) {
            return this.Update(Original_ImageID, ImageName, ImageData, Original_ImageID);
        }
    }
